        ...
        return [
            ...
            Actions\Action::make('export_pdf')
                ...
                ->action(function (array $data): void {
                    ...
                    // Buka URL download di tab baru supaya halaman tetap berada di Filament,
                    // modal akan tertutup otomatis setelah aksi selesai.
                    $jsUrl = json_encode($url);
                    $this->js("window.open($jsUrl, '_blank');");
                }),
        ];
    }
